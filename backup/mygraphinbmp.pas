...
begin
  ...
  if FCalculateON then
   begin
        ...
        FMinDistance:=0;
        DrawTreeID(IDNode,-1000,1000);//-maxLongint,maxLongint);//строим дерево помещая node, которые в дереве в список FListDraw
        ...
        if UpDown then
           begin
                ...
                //FMinDistance:=0;
                DrawTreeID(IDNode,-1000,1000);//-maxLongint,maxLongint);
